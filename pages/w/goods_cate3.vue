<template>
	<view class="goodCate">
		<view class="conter" :style="{ paddingTop: navBarHeight + 'px', height: 'calc(100vh - ' + navBarHeight + 'px)' }">
			<view class="aside">
			...
			<view class="wrapper">
				<scroll-view
					...
					:scroll-top="0"
					@scroll="scroll"
					:style="{ height: scrollHeight + 'px', paddingTop: '20rpx' }"
					:lower-threshold="50"
...
export default {
	...
	mounted() {
		...
		// #ifndef MP
		// H5和APP使用固定高度
		that.navBarHeight = 88; // 44px的导航栏 + 44px的状态栏，转换为rpx
		// #endif
